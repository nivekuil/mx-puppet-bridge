...
class StringFormatter {
        ...
        for (let i = 0; i < pattern.length; i++) {
            ...
            switch (char) {
                ...
                case "[": {
                    ...
                    i += res.length;
                    // i++ will be performed at the end of the for-loop. This would cause the
    ...
    static insertVar(pattern, vars, i) {
        let varName = "";
        i++;
        let length = 0;
